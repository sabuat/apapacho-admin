...
export default function BooksTab({ books, onBooksChange }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/trpc/books.create`, {
        method: 'POST',
        headers: {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-1">
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
          <h2 className="text-lg font-semibold mb-4 text-gray-900">Crear Nuevo Libro</h2>
      ...
      <div className="lg:col-span-2">
        <h2 className="text-lg font-semibold mb-4 text-gray-900">Libros Publicados</h2>
